...
.. fillintheblank:: L69P1
    ...
    Преузми датотеку `овом линку <../../_static/Film.mp4>`_. и промени тип датотеке у .wmv коришћењем програма за конверзију типова датотека.
...
.. fillintheblank:: L69P2
    ...
    Преузми датотеку Film.wmv `са овог линка <../../_static/Film.wmv>`_. и промени тип датотеке у .mp4 коришћењем програма за конверзију типова датотека.
    Колико меморијског простора (у MB) заузима Film.mp4? Одоговор унеси као цео број.
